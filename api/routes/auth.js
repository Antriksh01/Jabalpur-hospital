...
router.post("/tokenReciept", joinPatientTable);
// router.get("/Search-patient", SearchPatientController);
router.post("/Search-patient", SearchPatientController);
...
router.post("/searchTokenhistory", SearchTokenHistory);
// router.get("/searchPatientQueue", searchPatientQueue);
router.post("/searchPatientQueue", searchPatientQueue);
// router.get("/searchPatientServe", searchPatientServe);
router.post("/searchPatientServe", searchPatientServe);
// router.get("/missed-partient", searchPatientMIssed);
router.post("/missed-partient", searchPatientMIssed);
// router.get("/searchAvailableDoctor", searchAvailableDoctor);
router.post("/searchAvailableDoctor", searchAvailableDoctor);
// router.get("/searchPatientAssigned", searchPatientAssigned);
router.post("/searchPatientAssigned", searchPatientAssigned);
