...
const ManageRec = () => {
  ...
  const countDoctors = async () => {
    try {
      ...
      const dt = await axios.post(
        `https://queuemanagementsystemdg.com/api/auth/get-patient-details`
      );
      const res = dt.data;
      setData(res);
      console.log(res);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `https://queuemanagementsystemdg.com/api/auth/update-rec-details/${updatedItem.Rec_ID}`,
        updatedItem
      );
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete(
        `https://queuemanagementsystemdg.com/api/auth/delete-receptionist/${deletedItem.Rec_ID}`
      );
