...
const TokenSearch = () => {
  ...
  const sendSMS = async (e) => {
    ...
    PatientName: ${modalValues.firstname} ${modalValues.lastname} ,
    AssignedDoctor: ${modalValues.Assigned_doctor} ,
    Department: ${modalValues.Dept},
    TokenGeneratedby: ${modalValues.Token_Generated_by},
    RoomNo: ${modalValues.Room_No},
    CounterNo: ${modalValues.Counter_No}`;
